      ...
      <div className="flex items-center gap-4">
        ...
        {isLoggedIn ? (
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <div className="cursor-pointer w-10 h-10 rounded-full bg-gray-100 border border-gray-200 flex items-center justify-center hover:bg-gray-200 transition-colors">
              ...
              <div className="absolute right-0 mt-3 w-48 bg-white border border-gray-100 rounded-2xl shadow-xl py-2 z-50">
                ...
                <div className="border-t border-gray-50 mt-1">
                  <button 
                    ...
                    className="cursor-pointer flex items-center gap-2 w-full px-4 py-2.5 text-sm text-rose-600 hover:bg-rose-50 font-bold"
                  >
                    Logout
                  </button>
                </div>
